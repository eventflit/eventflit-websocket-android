...
public class TokenRegistryTest {
    ...
    private @Mock EventflitAndroidFactory factory;
    private EventflitAndroidOptions options = new EventflitAndroidOptions();
    ...
    public void receiveUploadsWhenNoCachedId() throws Exception {
        ...
        verify(client).post(
                eq(context),
                eq("https://nativepushclient-cluster1.eventflit.com/client_api/v1/clients"),
    ...
    public void receivesUpdatesWhenCachedId() throws Exception {
        PreferenceManager.
                ...
                edit().
                putString("__eventflit__client__key__fcm__superkey", "this-is-the-client-id")
                .apply();
        ...
        verify(client).put(
                eq(context),
                eq("https://nativepushclient-cluster1.eventflit.com/client_api/v1/clients/this-is-the-client-id/token"),
                eq(sentParams),
                eq("application/json"),
    ...
    public void onSuccessfulRegistrationSavesClientId() throws Exception {
        ...
        String cachedId = PreferenceManager.
                getDefaultSharedPreferences(context)
                .getString("__eventflit__client__key__fcm__superkey", null);
