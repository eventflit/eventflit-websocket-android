...
public class PushNotificationRegistrationTest {
    ...
    public void setUp() throws ManifestValidator.InvalidManifestException {
        ...
        when(factory.newTokenRegistry(
                any(String.class), any(RegistrationListenerStack.class), any(Context.class), any(PlatformType.class), any(EventflitAndroidOptions.class)
        )).thenReturn(tokenRegistry);

        when(factory.newSubscriptionManager(
                any(String.class), any(Context.class), any(String.class), any(EventflitAndroidOptions.class)
