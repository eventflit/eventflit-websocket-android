...
public class SubscriptionManagerTest {
    ...
    public void testSubscribe() throws IOException {
        ...
        verify(client).post(
                eq(context),
                eq("https://nativepushclient-cluster1.eventflit.com/client_api/v1/clients/123-456/interests/donuts"),
    ...
    public void testSendingListOfSubscriptions() throws IOException {
        ...
        inOrder.verify(client).post(
                eq(context),
                eq("https://nativepushclient-cluster1.eventflit.com/client_api/v1/clients/123-456/interests/kittens"),
                (HttpEntity) paramsCaptor.capture(),
                eq("application/json"),
                eq(subscriptionChangeHandler)
        );
